...
const results = {
  ...
  B: {
    ...
    personality:
      "Ты – человек, который не терпит глупостей и всегда знает, как решить даже самую сложную проблему, пусть иногда и нестандартными методами. Твоя независимость и хитрость помогают выкрутиться из любой ситуации. Кто-то может тебя бояться, но на самом деле, если заслужить твоё доверие, ты станешь лучшей союзницей.",
    traits: [
      "Острое чувство юмора и хитрость",
      "Независимость и любовь к свободе",
      "Проницательность и умение видеть суть вещей",
      "Неожиданная доброта к тем, кто этого заслужил",
    ],
  ...
  C: {
    title: "🧜‍♀️ Русалка",
    description:
      "Дева вод. Ночью вместе с подругами плещется на поверхности воды, а прохожего может защекотать до смерти или увести с собой.",
    personality:
    ...
    superpower:
      "Ты умеешь привлекать к себе тех, кто тебе интересен – они сами тянутся к тебе.",
